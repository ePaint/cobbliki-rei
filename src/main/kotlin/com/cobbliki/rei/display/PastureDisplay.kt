...
class PastureDisplay(val species: Species, val drops: List<DropInfo>, val chancePerMinute: Double) : CobblikiDisplay() {
    ...
    override fun getCategoryIdentifier(): CategoryIdentifier<*> = Categories.PASTURE
}
